...
namespace Xena.Contracts
{
    ...
    public static class PaymentMeansTypes
    {
        ...
        {
            get { return International.Concat(Danish).Concat(Norweigan).ToArray(); }
        }
        ...
        {
            get { return new[] { NO_Bank, NO_Bank_Mod_10, NO_Bank_Mod_11 }; }
        }

        public static string[] Danish
        {
            get { return new[] { DK_Bank, DK_FIK_71, DK_FIK_73, DK_FIK_75, DK_Giro_01, DK_Giro_04, DK_Giro_15, DK_NemKonto }; }
        }

        public static string[] UsedOnElectronicInvoices
        {
            get { return Danish.Concat(new[] { IBAN_NON_EU, IBAN_SWIFT }).ToArray(); }
        }
        public static string[] International
        {
            get { return new[] { Bank, IBAN_SWIFT, IBAN_NON_EU }; }
        }

        public static string[] UsedOnInvoices
        {
            get { return new[] { Bank, IBAN_NON_EU, IBAN_SWIFT, DK_Bank, NO_Bank }; }
        }
    ...
    {
#if DEBUG
        public static string ProtocolUsedByXena { get { return "http"; } }
#else
        public static string ProtocolUsedByXena { get { return "https"; } }
#endif
        ...
        public static class PartnerTypes
        {
            ...
            {
                get { return new[] {Xena_Person, Xena_Company, Xena_Indeterminate}; }
            }
        }
        ...
        public static class VatSystems
        {
            ...
            public static IEnumerable<string> All => new[] {Xena_VatSystem_Default, Xena_VatSystem_OneStop};
        }
        public static class VatSettlementTypes
        {
            public static IEnumerable<string> DefaultTypes
            {
                get { return new[] {Xena_Settlement, Xena_SettlementAdjustment}; }
            }
            public static IEnumerable<string> OneStopTypes
            {
                get { return new[] {Xena_OneStop_Settlement, Xena_OneStop_SettlementAdjustment}; }
            }
        ...
        public static class LedgerPostTypes
        {
            ...
            public static string[] All => new[] { Xena_LedgerPostType_Consumption, Xena_LedgerPostType_Resale };
        }
        ...
        {
            public static IEnumerable<string> All => new[] { LedgerPost, LedgerPostPreview, LedgerLine, PartnerPost, PartnerSaldo };
        ...
        public static class Themes
        {
            ...
            public static string[] All => new[] { Standard, MintGreen, OceanBlue, Blue, NaviBlue, Purple, Prikly, Pink, Rusty, Dusty, Yellow, LightYellow, Coffee, Dark };
        }
        ...
        public static class PartnerContextTypes
        {
            ...
            public static string[] AllContextTypes => new[] { Supplier,Customer, Resource, All };
        }

    }
    public static class ReportModules
    {
        public static string[] All => new[] { OrderInvoice, OrderDelivery, OrderConfirmation, OrderOffer, OrderPickList, FiscalBalance, PrimoFiscalBalance, Reminder, InventoryCountingList, VatSettlement, VatSettlement_OneStop,ArticleGroupStatisticReportList, ArticleMarginReportList, ArticlePostReportList, ArticleStockReportList, HistoricStockValueReportList, LedgerPostReportList, LedgerTagStatisticReportList, PartnerPostReportList, PartnerSaldoReportList, PartnerSaldoAgeReportList, PartnerStatisticReportList, LedgerAccountSpecificationReportList, FiscalBalanceAccountant, LedgerJournal, EUSalesVatFree, PriceAgreementReportList };
        public static string[] Printable => new[] { OrderInvoice, OrderDelivery, OrderConfirmation, OrderOffer, OrderPickList };
