...
namespace Xena.Contracts.Domain
{
    public class LocationDto :  EntityDto
    {
        ...
        public string LocationTypeTranslated => string.IsNullOrEmpty(LocationType) ? string.Empty : LocationType.GetLocalizedConstant();
        public string LastCountedDaysFriendly => LastCountedDays.HasValue ? LastCountedDays.Value.FriendlyString() : string.Empty;
    }
}