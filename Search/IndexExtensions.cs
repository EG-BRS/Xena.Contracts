...
namespace Xena.Contracts.Search
{
    public static class IndexExtensions
    {
        ...
        public static PartnerSearchIndex CreateSearchIndex(this PartnerDto partner, Func<long, IList<PartnerTelephoneNumberDto>> getTelephoneNumbers, Func<long, IList<PartnerEmailContactDto>> getEmailContacts, Func<long, IEnumerable<OrderContextDto>> getOrderContexts)
        {
