namespace Xena.Contracts.ApiRoutes
{
    public class SupporterRoutes : BaseRoutes
    {
        ...
        public const string IsLimitedFiscal = "FiscalSetup/{fiscalSetupId}/IsLimitedFiscal";
        ...
        public const string DeleteLimitedFiscal = "FiscalSetup/{fiscalSetupId}/LimitedFiscal";
}
}